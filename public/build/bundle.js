    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 25, 2, 790);
    			add_location(div0, file$3, 24, 1, 782);
    			add_location(br0, file$3, 27, 1, 836);
    			add_location(br1, file$3, 27, 5, 840);
    			attr_dev(input0, "id", "inputUsername");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 28, 11, 856);
    			add_location(br2, file$3, 28, 49, 894);
    			attr_dev(input1, "id", "inputPassword");
    			attr_dev(input1, "type", "text");
    			input1.value = "this input does nothing for now. pls ignore";
    			add_location(input1, file$3, 29, 11, 910);
    			add_location(br3, file$3, 29, 101, 1000);
    			add_location(br4, file$3, 30, 88, 1093);
    			add_location(br5, file$3, 30, 152, 1157);
    			attr_dev(p0, "id", "noNeedToVerify");
    			set_style(p0, "display", "none");
    			add_location(p0, file$3, 30, 1, 1006);
    			add_location(br6, file$3, 30, 160, 1165);
    			add_location(strong0, file$3, 32, 1, 1172);
    			add_location(br7, file$3, 32, 110, 1281);
    			add_location(br8, file$3, 32, 114, 1285);
    			add_location(strong1, file$3, 34, 1, 1292);
    			add_location(br9, file$3, 34, 61, 1352);
    			add_location(br10, file$3, 34, 134, 1425);
    			add_location(br11, file$3, 36, 45, 1518);
    			attr_dev(p1, "id", "captchaPlease");
    			set_style(p1, "display", "none");
    			add_location(p1, file$3, 36, 1, 1474);
