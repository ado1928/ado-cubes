    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input1, "type", "text");
    			input1.value = "KeyA";
    			add_location(input1, file$2, 35, 4, 834);
    			attr_dev(input2, "type", "text");
    			input2.value = "KeyS";
    			add_location(input2, file$2, 36, 4, 871);
    			attr_dev(input3, "type", "text");
    			input3.value = "KeyD";
    			add_location(input3, file$2, 37, 4, 908);
    			...
    			input4.value = "KeyX";
    			add_location(input4, file$2, 40, 20, 980);
    			add_location(div3, file$2, 40, 2, 962);
    			attr_dev(input5, "id", "inputSecondaryPlaceBlocks");
    			attr_dev(input5, "type", "text");
    			input5.value = "MouseRight";
    			add_location(input5, file$2, 41, 17, 1058);
    			add_location(div4, file$2, 41, 2, 1043);
    			attr_dev(input6, "id", "inputRemoveBlocks");
    			attr_dev(input6, "type", "text");
    			input6.value = "KeyC";
    			add_location(input6, file$2, 42, 21, 1155);
    			add_location(div5, file$2, 42, 2, 1136);
    			attr_dev(input7, "id", "inputSecondaryRemoveBlocks");
    			attr_dev(input7, "type", "text");
    			input7.value = "MouseLeft";
    			add_location(input7, file$2, 43, 17, 1234);
    			add_location(div6, file$2, 43, 2, 1219);
    			attr_dev(input8, "id", "inputFasterPaletteScroll");
    			attr_dev(input8, "type", "text");
    			input8.value = "AltLeft";
    			add_location(input8, file$2, 44, 29, 1339);
    			add_location(div7, file$2, 44, 2, 1312);
    			add_location(h12, file$2, 46, 2, 1414);
    			attr_dev(input9, "id", "masterVolume");
    			attr_dev(input9, "class", "slider");
    			attr_dev(input9, "type", "range");
    			add_location(input9, file$2, 47, 29, 1458);
    			add_location(div8, file$2, 47, 2, 1431);
    			attr_dev(input10, "id", "musicVolume");
    			attr_dev(input10, "class", "slider");
    			attr_dev(input10, "type", "range");
    			add_location(input10, file$2, 48, 27, 1571);
    			add_location(div9, file$2, 48, 2, 1546);
    			attr_dev(input11, "id", "sfxVolume");
    			attr_dev(input11, "class", "slider");
    			attr_dev(input11, "type", "range");
    			add_location(input11, file$2, 49, 23, 1678);
    			add_location(div10, file$2, 49, 2, 1657);
    			attr_dev(input12, "id", "uiVolume");
    			attr_dev(input12, "class", "slider");
    			attr_dev(input12, "type", "range");
    			add_location(input12, file$2, 50, 21, 1779);
    			add_location(div11, file$2, 50, 2, 1760);
    			attr_dev(input13, "type", "checkbox");
    			add_location(input13, file$2, 52, 39, 1897);
    			add_location(div12, file$2, 52, 2, 1860);
    			add_location(h13, file$2, 54, 2, 1930);
    			add_location(div13, file$2, 55, 2, 1953);
    			add_location(h14, file$2, 57, 2, 1988);
    			attr_dev(input14, "type", "checkbox");
    			add_location(input14, file$2, 58, 28, 2039);
    			add_location(div14, file$2, 58, 2, 2013);
    			attr_dev(input15, "type", "checkbox");
    			add_location(input15, file$2, 59, 22, 2091);
    			add_location(div15, file$2, 59, 2, 2071);
    			add_location(h15, file$2, 61, 2, 2124);
    			add_location(strong, file$2, 62, 7, 2146);
    			add_location(div16, file$2, 62, 2, 2141);
    			...
    			add_location(div17, file$2, 63, 2, 2216);
    			attr_dev(input16, "type", "file");
    			add_location(input16, file$2, 64, 2, 2317);
