    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div2, "background", "#777777");
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "id", "signContent");
    			set_style(textarea, "max-height", "450px");
    			set_style(textarea, "white-space", "pre");
    			textarea.value = "This is a sign! or a cubic sign?\n─────────────────────────────────────────────────────\nthe quick brown fox jumps over the lazy dog\nThe quick brown fox jumps over the lazy dog.\nTHE QUICK BROWN FOX JUMPS OVER THE LAZY DOG\nTHE QUICK BROWN FOX JUMPS OVER THE LAZY DOG!!!\n                 .-˙-.\n              .-˙ ˙.˙ ˙-.        adobe photoshop\n           .-˙ .˙.˙.˙.˙. ˙-.          1999\n        .-˙.˙.˙.˙.˙.˙.˙.˙.˙.˙-.\n        |-. ˙.˙.˙.˙.˙.˙.˙.˙ .-|    𝗺cdonalds はいー \n        |  ˙-.˙.˙.˙.˙.˙.˙.-˙  |           ( ◕͡  ͜ʖ◕͡ )\n        |     ˙-. ˙.˙ .-˙     |       🥚    🥚egg🥚🥚\n        |       adocubes      |         🥚🥚  🥚 🥚\n    made in Three.js & Svelte with ❤    🥚 🥚 🥚\n        |          |          |               🐔\n        ˙-.        |        .-˙        𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆𛲆\n           ˙-.     |     .-˙             ─  ─  ─  ─\n              ˙-.  |  .-˙     md2      𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖𛲖\n                 ˙-|-˙\n";
    			add_location(textarea, file$8, 13, 0, 329);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			create_component(sign.$$.fragment);
    			t3 = space();
    			...
    			attr_dev(img, "alt", "+");
    			add_location(img, file, 25, 2, 651);
    			...
    			add_location(div1, file, 29, 2, 767);
    			...
    			add_location(div2, file, 30, 2, 870);
    			...
    			add_location(div3, file, 31, 2, 972);
    			attr_dev(div4, "id", "mobileControls");
    			add_location(div4, file, 28, 1, 739);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, t2);
    			mount_component(sign, div0, null);
    			append_dev(div0, t3);
    		...
    		i: function intro(local) {
    			...
    			transition_in(sign.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(sign.$$.fragment, local);
